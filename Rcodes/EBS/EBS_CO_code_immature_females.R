...
alt_6_bio %>% 
  select(BIOMASS_FEMALE_IMMATURE, CV_BIOMASS_FEMALE_IMMATURE, CI_BIOMASS_FEMALE_IMMATURE) %>%
  rename_all(~c("ALT6_BIO_FEMALE_IMMATURE", "ALT6_CV_BIO_FEMALE_IMMATURE", "ALT6_CI_BIO_FEMALE_IMMATURE"))-> alt_6_immatfembio

all_bio<-as.data.frame(cbind(base_immatfembio, alt_1_immatfembio, alt_2_immatfembio, alt_3_immatfembio, 
                             alt_4_immatfembio, alt_5_immatfembio, alt_6_immatfembio))
###########
...
alt_6_abun %>%
  select(NUM_FEMALE_IMMATURE, CV_NUM_FEMALE_IMMATURE, CI_NUM_FEMALE_IMMATURE) %>%
  rename_all(~c("ALT6_ABUN_FEMALE_IMMATURE", "ALT6_CV_ABUN_FEMALE_IMMATURE","ALT6_CI_ABUN_FEMALE_IMMATURE")) -> alt_6_immatfemabun
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_BIO_FEMALE_IMMATURE, color ="baseline", size = 3))+
  ...
  geom_point(aes(y=ALT6_BIO_FEMALE_IMMATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  ...
  geom_point(aes(y=ALT6_BIO_FEMALE_IMMATURE), color = "brown", size = 3)
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CV_BIO_LE94, color ="baseline", size = 3))+
  ...
  geom_point(aes(y=ALT6_CV_BIO_FEMALE_IMMATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  ...
  geom_point(aes(y=ALT5_CV_BIO_FEMALE_IMMATURE), color = "blue", size = 3)+
  geom_point(aes(y=ALT6_CV_BIO_FEMALE_IMMATURE), color = "brown", size = 3)
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CI_BIO_LE94, color ="baseline", size = 3))+
  ...
  geom_point(aes(y=ALT6_CI_BIO_FEMALE_IMMATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  ...
  geom_point(aes(y=ALT6_CI_BIO_FEMALE_IMMATURE), color = "brown", size = 3)
...
all_bio %>%
  select(BASELINE_CV_BIO_FEMALE_IMMATURE,ALT1_CV_BIO_FEMALE_IMMATURE,
         ALT2_CV_BIO_FEMALE_IMMATURE,ALT3_CV_BIO_FEMALE_IMMATURE,ALT4_CV_BIO_FEMALE_IMMATURE
         ,ALT5_CV_BIO_FEMALE_IMMATURE,ALT6_CV_BIO_FEMALE_IMMATURE) %>% 
  colMeans(na.rm = TRUE) %>%
