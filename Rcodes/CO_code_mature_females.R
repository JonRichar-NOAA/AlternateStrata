...
alt_5_bio %>% 
  select(BIOMASS_FEMALE_MATURE, CV_BIOMASS_FEMALE_MATURE, CI_BIOMASS_FEMALE_MATURE) %>%
  rename_all(~c("ALT5_BIO_FEMALE_MATURE", "ALT5_CV_BIO_FEMALE_MATURE", "ALT5_CI_BIO_FEMALE_MATURE"))-> alt_5_matbio

alt_6_bio %>% 
  select(BIOMASS_FEMALE_MATURE, CV_BIOMASS_FEMALE_MATURE, CI_BIOMASS_FEMALE_MATURE) %>%
  rename_all(~c("ALT6_BIO_FEMALE_MATURE", "ALT6_CV_BIO_FEMALE_MATURE", "ALT6_CI_BIO_FEMALE_MATURE"))-> alt_6_matbio
...
alt_5_abun %>%
  select(NUM_FEMALE_MATURE, CV_NUM_FEMALE_MATURE, CI_NUM_FEMALE_MATURE) %>%
  rename_all(~c("ALT5_ABUN_FEMALE_MATURE", "ALT5_CV_ABUN_FEMALE_MATURE","ALT5_CI_ABUN_FEMALE_MATURE")) -> alt_5_matabun

alt_6_abun %>%
  select(NUM_FEMALE_MATURE, CV_NUM_FEMALE_MATURE, CI_NUM_FEMALE_MATURE) %>%
  rename_all(~c("ALT6_ABUN_FEMALE_MATURE", "ALT6_CV_ABUN_FEMALE_MATURE","ALT6_CI_ABUN_FEMALE_MATURE")) -> alt_6_matabun
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  ...
  geom_point(aes(y=ALT4_BIO_FEMALE_MATURE, color = "alternative 4"), size = 3)+
  geom_point(aes(y=ALT5_BIO_FEMALE_MATURE, color = "alternative 5"), size = 3)+
  geom_point(aes(y=ALT6_BIO_FEMALE_MATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  geom_point(aes(y=BASELINE_BIO_FEMALE_MATURE), color ="black", size = 5) +
  geom_point(aes(y=ALT1_BIO_FEMALE_MATURE), color = "red", size = 3) +
  geom_point(aes(y=ALT2_BIO_FEMALE_MATURE), color = "yellow", size = 3)+
  geom_point(aes(y=ALT3_BIO_FEMALE_MATURE), color = "green", size = 3)+
  geom_point(aes(y=ALT4_BIO_FEMALE_MATURE), color = "blue", size = 3)+
  geom_point(aes(y=ALT5_BIO_FEMALE_MATURE), color = "grey", size = 3)+
  geom_point(aes(y=ALT6_BIO_FEMALE_MATURE), color = "brown", size = 3)

################################ FEMALE_MATURE BIOMASS CV #########################################################################
names(all_bio)

ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CV_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  geom_point()+  
  ...
  geom_point(aes(y=ALT5_CV_BIO_FEMALE_MATURE, color = "alternative 5"), size = 3)+
  geom_point(aes(y=ALT6_CV_BIO_FEMALE_MATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  geom_point(aes(y=BASELINE_CV_BIO_FEMALE_MATURE), color ="black", size = 5) +
  geom_point(aes(y=ALT1_CV_BIO_FEMALE_MATURE), color = "red", size = 3) +
  geom_point(aes(y=ALT2_CV_BIO_FEMALE_MATURE), color = "orange", size = 3)+
  geom_point(aes(y=ALT3_CV_BIO_FEMALE_MATURE), color = "green", size = 3)+
  geom_point(aes(y=ALT4_CV_BIO_FEMALE_MATURE), color = "blue", size = 3)+
  geom_point(aes(y=ALT5_CV_BIO_FEMALE_MATURE), color = "grey", size = 3)+
  geom_point(aes(y=ALT6_CV_BIO_FEMALE_MATURE), color = "brown", size = 3)
  

################################ FEMALE_MATURE BIOMASS CI #########################################################################
names(all_bio)

ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CI_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  geom_point()+  
  ...
  geom_point(aes(y=ALT5_CI_BIO_FEMALE_MATURE, color = "alternative 5"), size = 3)+
  geom_point(aes(y=ALT6_CI_BIO_FEMALE_MATURE, color = "alternative 6"), size = 3)+
...
ggplot(all_bio, aes(x=SURVEY_YEAR))+
  geom_point(aes(y=BASELINE_CI_BIO_FEMALE_MATURE), color ="black", size = 5)+
  geom_point(aes(y=ALT1_CI_BIO_FEMALE_MATURE), color = "red", size = 3)+
  geom_point(aes(y=ALT2_CI_BIO_FEMALE_MATURE), color = "orange", size = 3)+
  geom_point(aes(y=ALT3_CI_BIO_FEMALE_MATURE), color = "green", size = 3)+
  geom_point(aes(y=ALT4_CI_BIO_FEMALE_MATURE), color = "blue", size = 3)+
  geom_point(aes(y=ALT5_CI_BIO_FEMALE_MATURE), color = "grey", size = 3) +
  geom_point(aes(y=ALT6_CI_BIO_FEMALE_MATURE), color = "brown", size = 3)
...
all_bio %>%
  select(BASELINE_CV_BIO_FEMALE_MATURE, ALT1_CV_BIO_FEMALE_MATURE, ALT2_CV_BIO_FEMALE_MATURE, ALT3_CV_BIO_FEMALE_MATURE,
  ALT4_CV_BIO_FEMALE_MATURE,ALT5_CV_BIO_FEMALE_MATURE,ALT6_CV_BIO_FEMALE_MATURE) %>% 
  colMeans(na.rm = TRUE) %>%
