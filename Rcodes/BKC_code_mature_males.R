...
base_bio %>%
  ...
  rename_all(~c("SURVEY_YEAR", "BASELINE_BIO_GE94", "BASELINE_CV_BIO_GE94", "BASELINE_CI_BIO_GE94")) -> base_matbio
  
alt_1_bio %>% 
  select(BIOMASS_MALE_GE94, CV_BIOMASS_MALE_GE94, CI_BIOMASS_MALE_GE94) %>%
     rename_all(~c("ALT1_BIO_GE94", "ALT1_CV_BIO_GE94", "ALT1_CI_BIO_GE94"))-> alt_1_matbio

alt_2_bio %>% 
  select(BIOMASS_MALE_GE94, CV_BIOMASS_MALE_GE94, CI_BIOMASS_MALE_GE94) %>%
   rename_all(~c("ALT2_BIO_GE94", "ALT2_CV_BIO_GE94", "ALT2_CI_BIO_GE94"))-> alt_2_matbio

alt_3_bio %>% 
  select(BIOMASS_MALE_GE94, CV_BIOMASS_MALE_GE94, CI_BIOMASS_MALE_GE94) %>%
   rename_all(~c("ALT3_BIO_GE94", "ALT3_CV_BIO_GE94", "ALT3_CI_BIO_GE94"))-> alt_3_matbio

alt_4_bio %>% 
  select(BIOMASS_MALE_GE94, CV_BIOMASS_MALE_GE94, CI_BIOMASS_MALE_GE94) %>%
   rename_all(~c("ALT4_BIO_GE94", "ALT4_CV_BIO_GE94", "ALT4_CI_BIO_GE94"))-> alt_4_matbio
...
base_abun %>%
  ...
  rename_all(~c("SURVEY_YEAR", "BASELINE_ABUN_GE94", "BASELINE_CV_ABUN_GE94","BASELINE_CI_ABUN_GE94")) -> base_matabun

alt_1_abun %>%
  select(NUM_MALE_GE94, CV_NUM_MALE_GE94, CI_NUM_MALE_GE94) %>%
  rename_all(~c("ALT1_ABUN_GE94", "ALT1_CV_ABUN_GE94","ALT1_CI_ABUN_GE94")) -> alt_1_matabun

alt_2_abun %>%
  select(NUM_MALE_GE94, CV_NUM_MALE_GE94, CI_NUM_MALE_GE94) %>%
  rename_all(~c("ALT2_ABUN_GE94", "ALT2_CV_ABUN_GE94","ALT2_CI_ABUN_GE94")) -> alt_2_matabun

alt_3_abun %>%
  select(NUM_MALE_GE94, CV_NUM_MALE_GE94, CI_NUM_MALE_GE94) %>%
  rename_all(~c("ALT3_ABUN_GE94", "ALT3_CV_ABUN_GE94","ALT3_CI_ABUN_GE94")) -> alt_3_matabun

alt_4_abun %>%
  select(NUM_MALE_GE94, CV_NUM_MALE_GE94, CI_NUM_MALE_GE94) %>%
  rename_all(~c("ALT4_ABUN_GE94", "ALT4_CV_ABUN_GE94","ALT4_CI_ABUN_GE94")) -> alt_4_matabun
...
all_bio %>%
  select(BASELINE_CV_BIO_GE94,ALT1_CV_BIO_GE94,ALT2_CV_BIO_GE94,ALT3_CV_BIO_GE94,ALT4_CV_BIO_GE94) %>% 
  colMeans(na.rm = TRUE) %>%
