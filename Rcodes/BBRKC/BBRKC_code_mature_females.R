...
##### Import data
base_bio<-read_csv("./Data/rk_bb_leg3_biomass_baseline.csv")

alt_1_bio<-read_csv("./Data/rk_bb_leg3_biomass_alternate_strata_1.csv")
alt_2_bio<-read_csv("./Data/rk_bb_leg3_biomass_alternate_strata_2.csv")
alt_3_bio<-read_csv("./Data/rk_bb_leg3_biomass_alternate_strata_3.csv")


base_abun<-read_csv("./Data/rk_bb_leg3_abundance_baseline.csv")

alt_1_abun<-read_csv("./Data/rk_bb_leg3_abundance_alternate_strata_1.csv")
alt_2_abun<-read_csv("./Data/rk_bb_leg3_abundance_alternate_strata_2.csv")
alt_3_abun<-read_csv("./Data/rk_bb_leg3_abundance_alternate_strata_3.csv")
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  ...
  labs(colour="Datasets",y="Mature Female Biomass (MT)",x="Survey Year")+ 
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CV_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  ...
  labs(colour="Datasets",y="Mature Female Biomass CV",x="Survey Year")+ 
  theme(legend.position = c(0, 1),legend.justification = c(0, 1))+
  scale_color_manual(values = c( "black","red", "blue", "green"))
...
ggplot(all_bio, aes(x=SURVEY_YEAR, y=BASELINE_CI_BIO_FEMALE_MATURE, color ="baseline", size = 5))+
  ...
  labs(colour="Datasets",y="Mature Female Biomass CI",x="Survey Year")+ 
  theme(legend.position = c(0, 1),legend.justification = c(0, 1))+
  scale_color_manual(values = c("black","red", "blue", "green"))
